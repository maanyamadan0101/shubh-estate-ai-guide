      ...
      <section className="container-page py-16">
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr]">
          <div>
            <SectionHead
              eyebrow="Our Promise"
              title="Integrity, clarity and investment safety before the transaction"
            />
          ...
          <div className="rounded-2xl surface-navy p-8">
            ...
            <p className="mt-4 text-navy-foreground/80">
              A property can look attractive and still be a poor financial decision. The risk may
              sit in an inflated price, unclear ownership history, incomplete title chain,
              unsuitable financing, weak documentation or an exit assumption that does not stand up
              to scrutiny. Our process starts by understanding these risks before asking a client to
              commit capital.
            </p>
            <p className="mt-5 text-navy-foreground/80">
              We believe the brokerage relationship must be built on integrity. When a deal does not
              make financial, legal or practical sense, the client should hear that clearly — even
              if it means walking away from the transaction.
            </p>
      ...
      <section className="bg-secondary/60 py-16">
        <div className="container-page">
          <SectionHead
            ...
            title="Arun Madaan — Gurugram Real Estate & Mortgage Advisor"
          />
          <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_1.2fr]">
            <div className="rounded-2xl border border-border bg-card p-8">
              <p className="font-display text-2xl">Arun Madaan</p>
              <p className="mt-1 text-sm text-muted-foreground">
                Founder & Promoter, Shubh Estate Brokers · MBA · LLB · Former Senior Banking
                Professional
              </p>
            ...
            <div>
              <p className="text-muted-foreground">
                Arun Madaan leads Shubh Estate Brokers in Gurugram. His senior-level banking
                exposure provides a perspective that goes beyond conventional property brokerage.
                Years spent around credit, mortgages, collateral valuation, documentation and title
                processes shape how he evaluates residential property transactions and investment
                decisions today.
              </p>
              <p className="mt-5 text-muted-foreground">
                This background brings a deeper understanding of how title is created and examined,
                how lenders assess a property, where documentation gaps can create risk, how
                financing affects the true cost of ownership, and how buyers and investors should
                think about capital protection before expected returns.
              </p>
              <p className="mt-5 text-muted-foreground">
                Through Shubh Estate Brokers, Arun advises buyers, sellers and property investors
                across Gurugram, including resale property, luxury homes, builder floors, mortgage
                coordination, valuation and title/documentation assessment. The guiding principle is
                simple: integrity comes before commission.
              </p>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Button asChild variant="navy">
                  <a href={CONTACT.phoneHref}>Speak with Arun Madaan</a>
                </Button>
                <Button asChild variant="outline">
                  <a href={CONTACT.googleBusinessProfile} target="_blank" rel="noreferrer">
                    View Shubh Estate Brokers on Google
                  </a>
                </Button>
                <Button asChild variant="outline">
                  <a href={ARUN_LINKEDIN} target="_blank" rel="noreferrer">
                    Arun Madaan on LinkedIn
                  </a>
                </Button>
              </div>
            </div>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            ...
            >
              <p className="font-display text-xl">Gurugram buyer advisory</p>
              <p className="mt-2 text-sm text-muted-foreground">
                See how Arun and Shubh Estate Brokers shortlist, compare and review Gurgaon property
                before a commitment.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Understand eligibility, valuation, documentation, balance transfer and lender
                coordination.
              </p>
            </Link>
            <Link
              ...
              className="rounded-xl border border-border bg-card p-5 hover:border-gold/50"
            >
              <p className="font-display text-xl">Current Gurugram properties</p>
              <p className="mt-2 text-sm text-muted-foreground">
                Browse current resale, rental and under-construction inventory across Gurugram.
              </p>
            </Link>
          </div>
        </div>
