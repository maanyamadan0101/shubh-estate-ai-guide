...
const STATIC_PATHS = [
  ...
  { path: "/locations/sector-46-gurgaon", priority: "0.7" },
  { path: "/locations/sector-49-gurgaon", priority: "0.7" },
  { path: "/locations/sector-56-gurgaon", priority: "0.7" },
  { path: "/locations/sector-62-gurgaon", priority: "0.8" },
  { path: "/locations/sector-65-gurgaon", priority: "0.8" },
  { path: "/locations/sector-66-gurgaon", priority: "0.8" },
  { path: "/locations/sector-82-gurgaon", priority: "0.7" },
  { path: "/locations/sector-85-gurgaon", priority: "0.7" },
  { path: "/locations/sector-86-gurgaon", priority: "0.7" },
  { path: "/locations/sector-102-gurgaon", priority: "0.8" },
  { path: "/locations/sector-113-gurgaon", priority: "0.7" },
