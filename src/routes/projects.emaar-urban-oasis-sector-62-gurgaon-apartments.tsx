...
const PAGE_PATH = "/projects/emaar-urban-oasis-sector-62-gurgaon-apartments";
...
const GREEN =
  "https://cdn.in.emaar.com/wp-content/uploads/2023/08/Main-Community-Image-1-1-1620x832.jpg";
...
export const Route = createFileRoute("/projects/emaar-urban-oasis-sector-62-gurgaon-apartments")({
  head: () => ({
    meta: [
      { title },
    ...
    <main className="overflow-hidden bg-background">
        ...
        <div className="container-page grid min-h-[700px] items-center gap-12 py-20 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-white/72 sm:text-lg">
              A buyer-focused guide to Emaar Urban Oasis with official Emaar references, RERA
              context and current resale asking signals. Emaar's official page currently marks the
              original offering <strong className="text-white">Sold Out</strong>, so this page
              focuses on verifying resale and assignment opportunities rather than implying fresh
              developer inventory.
            </p>
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Button asChild size="xl" variant="gold">
                ...
                >
                  Get Current Resale Inventory <MessageCircle />
                </a>
              </Button>
              <Button asChild size="xl" variant="goldOutline">
                <a href="#price">
                  Check Current Asking Prices <ArrowRight />
                </a>
              </Button>
            </div>
          </div>
          <figure className="overflow-hidden rounded-[2rem] border border-white/15 shadow-2xl">
            <img
              src={HERO}
              alt="Official Emaar artistic impression of Urban Oasis Sector 62 Gurugram"
              width={1620}
              height={832}
              fetchPriority="high"
              className="aspect-[16/10] w-full object-cover"
            />
            <figcaption className="bg-navy px-5 py-3 text-xs text-white/60">
              Official Emaar artistic impression
            </figcaption>
          </figure>
        </div>
      </section>
      ...
      <section id="overview" className="container-page py-16 sm:py-20">
        <Heading
          ...
          title="Separate the original Emaar offering from today's resale market"
          copy="The original Urban Oasis page from Emaar remains the primary source for project positioning and amenities. Current resale availability and prices are unit-specific and should be independently verified."
        />
        ...
        <div className="mt-7 flex flex-wrap gap-4 text-sm">
          ...
          >
            Official Emaar page <ExternalLink className="size-4" />
          </a>
          <a
            href={EMAAR_BROCHURE}
            target="_blank"
            ...
            className="inline-flex items-center gap-1.5 font-medium text-gold hover:underline"
          >
            Official brochure <ExternalLink className="size-4" />
          </a>
          <a
            href={RERA_PAGE}
            target="_blank"
            ...
            className="inline-flex items-center gap-1.5 font-medium text-gold hover:underline"
          >
            Haryana RERA <ExternalLink className="size-4" />
          </a>
        </div>
      ...
      <section id="price" className="border-y border-border bg-secondary/25 py-16 sm:py-20">
        <div className="container-page">
          <Heading
            eyebrow="Current online asking snapshot"
            title="2,122 sq ft 3 BHK listings currently span a wide range"
            copy="Recent portal advertisements demonstrate why an average project rate is not enough. Floor, view, seller payment status, outstanding builder demands and transfer economics can materially change the effective acquisition cost."
          />
          <div className="mt-10 overflow-hidden rounded-2xl border border-border bg-card">
            <div className="grid grid-cols-[.8fr_.8fr_.8fr] gap-3 border-b border-border bg-muted/40 px-5 py-4 text-xs font-semibold uppercase tracking-wide text-muted-foreground sm:grid-cols-4">
              <span>Area</span>
              <span>Asking</span>
              <span>₹/sq ft</span>
              <span className="hidden sm:block">Reference</span>
            </div>
            {RESALE_SNAPSHOT.map(([area, asking, rate, reference]) => (
              <div
                key={`${asking}-${rate}`}
                className="grid grid-cols-[.8fr_.8fr_.8fr] gap-3 border-b border-border px-5 py-4 text-sm last:border-0 sm:grid-cols-4"
              >
          ...
          <div className="mt-7 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm leading-7 text-amber-950">
            <strong>Price caution:</strong> These are online asking references, not registered
            transaction prices. A lower asking price can reflect a different floor/view, payment
            stage, urgent seller terms or incomplete cost disclosure. Verify the complete
            acquisition cost before comparison.
          </div>
          <div className="mt-7 flex flex-wrap gap-3">
            <Button asChild variant="gold">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                onClick={() => trackContact("whatsapp", "urban_oasis_price")}
              >
                Request Verified Resale Inventory <MessageCircle />
              </a>
            </Button>
            <Button asChild variant="outline">
              <Link to={CURRENT_LISTING}>View Current Shubh Listing</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section id="video" className="container-page py-16 sm:py-20">
        <div className="grid gap-10 lg:grid-cols-[.7fr_1.3fr] lg:items-center">
          <div>
            <Video className="size-8 text-gold" />
            <Heading
              eyebrow="Official Emaar promotional film"
              title="See the project vision before comparing a resale unit"
              copy="Use project marketing to understand the planned environment, then verify the exact resale unit separately."
            />
            <Button asChild variant="navy" className="mt-7">
              <a href={WATCH_VIDEO} target="_blank" rel="noreferrer">
                Watch on YouTube <ExternalLink />
              </a>
            </Button>
          </div>
          <div className="aspect-video overflow-hidden rounded-3xl border border-border bg-black shadow-xl">
            <iframe
              className="h-full w-full"
              src={VIDEO}
              title="Official Emaar Urban Oasis promotional video"
              loading="lazy"
      ...
      <section id="amenities" className="border-y border-border bg-secondary/25 py-16 sm:py-20">
        <div className="container-page">
          <Heading
            eyebrow="Official amenities"
            title="Lifestyle features highlighted by Emaar"
            copy="Amenities below are based on Emaar's official Urban Oasis material; exact operational status and phase access should be verified at possession."
          />
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            <figure className="overflow-hidden rounded-3xl border border-border bg-card">
              <img
                src={GREEN}
                alt="Official Emaar Urban Oasis landscaped green artistic impression"
                loading="lazy"
                className="aspect-[16/10] w-full object-cover"
              />
            ...
            <figure className="overflow-hidden rounded-3xl border border-border bg-card">
              <img
                src={POOL}
                alt="Official Emaar Urban Oasis amenity and pool artistic impression"
                loading="lazy"
                className="aspect-[16/10] w-full object-cover"
              />
              <figcaption className="p-4 text-xs text-muted-foreground">
      ...
      <section id="location" className="container-page py-16 sm:py-20">
        <div className="grid gap-10 lg:grid-cols-[.75fr_1.25fr] lg:items-start">
          <div>
            ...
            <Heading
              eyebrow="Sector 62"
              title="Golf Course Extension Road market context"
              copy="Urban Oasis should be compared with Sector 62 and the wider Golf Course Extension Road corridor, not evaluated in isolation."
            />
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Link
              to="/higher-floor-apartments-golf-course-extension-road"
              className="rounded-2xl border border-border bg-card p-6 transition hover:border-gold/50"
            >
              <h3 className="font-display text-xl text-navy">Higher-floor apartments</h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Useful when floor, view and openness materially affect the shortlist.
              </p>
            </Link>
            <Link
              to="/projects/godrej-vrikshya-sector-103-gurgaon-apartments"
              className="rounded-2xl border border-border bg-card p-6 transition hover:border-gold/50"
            >
              <h3 className="font-display text-xl text-navy">Compare Godrej Vrikshya</h3>
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Compare this Golf Course Extension Road option with a Sector 103 Dwarka Expressway
                project.
              </p>
            </Link>
          </div>
      ...
      <section id="due-diligence" className="border-y border-border bg-secondary/25 py-16 sm:py-20">
        <div className="container-page">
          <Heading
            eyebrow="Resale due diligence"
            title="What to verify before agreeing on a resale price"
            copy="The correct comparison is the effective acquisition cost of the exact unit—not the portal headline alone."
          />
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[
              [
                "Exact unit & phase",
                "Tower, floor, facing, view, unit schedule and the applicable RERA registration.",
              ],
              [
                "Area basis",
                "Carpet area, balcony/exclusive area and the saleable or built-up figure used in advertisements.",
              ],
              [
                "Payment position",
                "Amount already paid, future Emaar demands, overdue amounts and seller receivables.",
              ],
              [
                "Transfer terms",
                "Assignment/resale eligibility, developer process, documentation and applicable charges.",
              ],
              [
                "Comparable asks",
                "Like-for-like units rather than mixing different sizes, floors, payment stages or phases.",
              ],
              [
                "Funding & valuation",
                "Bank valuation, loan eligibility and timing of disbursement relative to transfer.",
              ],
            ].map(([name, body]) => (
      ...
      <section id="faq" className="container-page py-16 sm:py-20">
        <Heading
          eyebrow="Buyer FAQ"
          title="Emaar Urban Oasis questions to resolve before paying a token"
        />
      ...
      <section className="container-page pb-20">
        <div className="grid gap-8 rounded-3xl surface-navy p-7 text-white sm:p-10 lg:grid-cols-[1fr_24rem]">
          <div>
            <p className="eyebrow">Resale shortlist</p>
            <h2 className="mt-3 font-display text-3xl sm:text-4xl">
              Compare the exact Urban Oasis unit
            </h2>
            <p className="mt-4 max-w-2xl leading-7 text-white/70">
              Share your budget, preferred size, floor and view. We can compare current seller asks
              with payment status, future demands and transaction structure before a site visit.
            </p>
          </div>
          <div className="rounded-2xl bg-white p-5 text-foreground">
            <EnquiryForm
              interest="Emaar Urban Oasis Sector 62 resale"
              compact
              includeRequirements
            />
          </div>
