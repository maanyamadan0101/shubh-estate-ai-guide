        ...
        <div className="container-page py-14 md:py-20">
          ...
          <div className="mt-6 max-w-4xl">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-gold">
              Corridor → Sector → Project → Property
            </p>
            <h1 className="mt-3 font-display text-4xl leading-tight md:text-5xl">
              Golf Course Extension Road Gurgaon property guide
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-7 text-muted-foreground">
              Compare Golf Course Extension Road through its actual sectors and projects, then move
              into genuine unit-level inventory. This creates a cleaner buyer journey than treating
              the entire corridor as one undifferentiated property list.
            </p>
        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h2 className="mt-1 font-display text-3xl">
              Published Golf Course Extension Road properties
            </h2>
          </div>
          <Link
            to="/properties"
