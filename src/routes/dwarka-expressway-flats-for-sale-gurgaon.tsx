...
const inventory: ProjectInventory[] = [
  ...
  },
  {
    ...
    context:
      "Established residential development close to Dwarka Expressway. The commonly marketed 3 BHK + servant layout is approximately 2025 sq ft.",
    units: [
      {
        configuration: "3 BHK + Servant",
        area: "Approx. 2025 sq ft",
        floor: "6th floor",
        price: "₹2.40 Cr",
      },
      {
    ...
    units: [
      {
        ...
        area: "2290 sq ft",
        floor: "Lower floor",
        facing: "Park, pool & expressway facing",
        price: "₹3.25 Cr",
      },
      {
        configuration: "3 BHK",
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        area: "2450 sq ft",
        floor: "Lower floor",
        facing: "Wing unit, park & pool facing",
        price: "₹3.60 Cr",
      },
      {
        configuration: "2 BHK + Servant",
        area: "1700 sq ft",
        floor: "Lower floor",
        facing: "Nose unit, park facing",
        price: "₹2.55–₹2.60 Cr",
      },
      {
        configuration: "2 BHK",
      ...
      },
      {
        configuration: "3 BHK + Servant",
        area: "2450 sq ft",
        floor: "High floor, Tower A3",
        facing: "Nose unit; park, pool, club & expressway views",
        price: "₹3.70 Cr",
      },
    ],
  },
  {
    ...
    sector: "Sector 104, Gurugram",
    context:
      "Dwarka Expressway residential development. The 2450 sq ft 4 BHK is part of the newer Tower 8 product and should be assessed separately from the earlier 2–3 BHK inventory.",
    units: [
      ...
      {
        configuration: "4 BHK – Tower 8",
        area: "2450 sq ft",
        floor: "Higher floor",
        price: "₹3.50 Cr",
        note: "Tower 8 is an under-construction 4 BHK phase; confirm the exact tower, payment schedule and possession terms.",
      },
    ],
  },
  {
    ...
    units: [
      {
        configuration: "3 BHK",
        area: "1855 sq ft",
        floor: "Middle to higher floor",
        price: "₹3.22–₹3.25 Cr",
      },
      {
        configuration: "3 BHK + Servant",
        area: "2002 sq ft",
        floor: "Lower to higher floor",
        price: "₹3.45 Cr",
      },
      {
        configuration: "4 BHK",
    ...
    units: [
      {
        ...
        area: "2700 sq ft",
        floor: "Higher floor",
        facing: "Corner / nose unit",
        price: "₹18,750 per sq ft",
      },
    ],
  },
  {
    ...
    context:
      "Large premium residential township near Dwarka Expressway with multiple apartment configurations.",
    units: [
      {
        configuration: "3 BHK",
        area: "2072 sq ft",
        floor: "Higher floor",
        price: "₹4.60 Cr",
        note: "Key-in-hand availability stated by the seller network; reconfirm before scheduling a visit.",
      },
  ...
  },
  {
    ...
    sector: "Sector 108, Gurugram",
    context:
      "Vista Residences is a premium phase within Sobha City, including Tower D and Tower Z inventory.",
    units: [
      {
        configuration: "3 BHK – Tower D",
        area: "2134 sq ft",
        floor: "Lower floor",
        price: "₹20,800 per sq ft",
      },
      {
        configuration: "3 BHK – Tower D",
        area: "2173 sq ft",
      ...
      {
        configuration: "4 BHK – Tower D",
        area: "2423 sq ft",
        floor: "Lower / higher floors",
        facing: "External facing; 2 units stated available",
      ...
      },
      {
        ...
        floor: "Middle floor",
        facing: "Internal facing",
        price: "₹24,500 per sq ft",
      },
      {
        configuration: "4 BHK – Tower Z",
        area: "2913 sq ft",
        floor: "Lower floor",
        price: "₹25,500 per sq ft",
      },
      {
        configuration: "3 BHK – Tower Z",
        area: "2073 sq ft",
        floor: "Lower floor",
        price: "₹26,000 per sq ft",
      },
    ],
  },
  {
    ...
    context:
      "Ready-to-move large-format residences in Sector 110 on the Dwarka Expressway corridor.",
    units: [
      {
        configuration: "4 BHK + Servant",
        area: "3400 sq ft",
  ...
  },
  {
    ...
    context:
      "Ready-to-move residential project in Sector 110A, close to the Dwarka Expressway corridor.",
    units: [
      {
        configuration: "3 BHK + Servant",
        area: "2042 sq ft",
  ...
  },
  {
    ...
    units: [
      {
        configuration: "3 BHK – Tower A2",
        area: "2282 sq ft",
        facing: "Central green / park facing",
        price: "₹19,000 per sq ft",
        note: "Seller-network reference price was ₹18,400 per sq ft; quoted resale demand is ₹19,000 per sq ft.",
      },
    ],
  },
  {
    ...
    context:
      "Ready residential inventory in Sector 36A within the wider Dwarka Expressway / New Gurugram catchment.",
    units: [
      {
        configuration: "2 BHK (LDK)",
        area: "1478 sq ft",
        floor: "10th–15th floor band",
        price: "₹22,200 per sq ft",
      },
      {
        configuration: "2 BHK (LDK)",
        area: "1448 sq ft",
        floor: "20th–25th floor band",
        price: "₹3.25 Cr",
      },
    ],
  },
...
function UnitCard({ unit }: { unit: Unit }) {
  return (
    <article className="rounded-xl border border-border bg-background p-5 shadow-sm">
      ...
      {unit.note ? (
        <p className="mt-3 text-xs leading-5 text-muted-foreground">{unit.note}</p>
      ) : null}
    </article>
  );
}
      ...
      <section className="container-page pt-10">
        <div className="overflow-hidden rounded-2xl border border-border bg-card">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 text-xs text-muted-foreground">
            <span>
              Representative corridor image — not a photograph of any specific listed apartment.
            </span>
            <a
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                These are current market leads received through the seller and broker network and
                cleaned for public display. Before paying any token, confirm the exact unit,
                ownership/title, RERA and tower details where applicable, occupation/completion
                documentation for ready homes, maintenance dues, transfer charges, parking,
                furnishing and the final negotiated price.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container-page pb-16">
        <div className="rounded-2xl border border-gold/30 bg-card p-7 md:p-9">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            Share your preferred sector, budget, configuration, floor and view. Shubh Estate Brokers
            can help compare the available unit against competing inventory and coordinate site
            visits, home-loan assessment and transaction due diligence.
          </p>
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link
              to="/projects/ansals-highland-park-sector-103-gurgaon-apartments"
              className="inline-flex min-h-10 items-center rounded-md border border-border px-5 text-sm font-medium transition-colors hover:border-gold hover:text-gold"
            >
