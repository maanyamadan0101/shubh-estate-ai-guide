...
const FAQS = [
  ...
  },
  {
    ...
    a: "The apartment is represented as unused. Buyers can inspect the actual condition through the photographs on this page and an in-person site visit.",
  },
  {
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Outstation and overseas buyers can review the actual photographs first and request the property walkthrough before arranging an in-person inspection or transaction-stage document coordination.",
          ],
        },
      ]}
      related={[
