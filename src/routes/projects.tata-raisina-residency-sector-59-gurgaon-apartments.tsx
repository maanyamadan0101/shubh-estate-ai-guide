...
const slug = "tata-raisina-residency-sector-59-gurgaon-apartments";
        ...
        <div className="container-page py-14 md:py-20">
          ...
          <div className="mt-6 max-w-4xl">
            ...
            <h1 className="mt-3 font-display text-4xl leading-tight md:text-5xl">
              Tata Raisina Residency, Sector 59 Gurgaon
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-7 text-muted-foreground">
              A buyer-first project and resale guide for Tata Raisina Residency, connecting stable
              project context with genuine Shubh Estate Brokers inventory whenever a unit is
              currently published.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <Button asChild variant="gold">
                <a href="#current-inventory">Check Current Inventory</a>
              </Button>
              <Button asChild variant="goldOutline">
                <Link to="/property-sector-59-gurgaon">Explore Sector 59</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="container-page grid gap-10 py-12 lg:grid-cols-[1fr_22rem]">
        <main className="space-y-12">
          <section>
            ...
            <h2 className="mt-2 font-display text-3xl">
              What buyers should know about Tata Raisina Residency
            </h2>
            <p className="mt-4 leading-7 text-muted-foreground">
              Tata Raisina Residency is an established Tata-branded residential community in Sector
              59 near the Aravalli foothills. Public developer information describes an
              approximately 12-acre setting with 9 residential towers and large-format luxury
              residences. For a resale buyer, however, project reputation is only the starting
              point: the exact tower, floor, orientation, view, apartment condition and commercial
              terms can materially change value.
            </p>
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              {[
                [
                  ...
                  "Evaluate the actual tower, common areas, maintenance and resident environment rather than only brochure positioning.",
                ],
                [
                  MapPin,
                  "Sector 59 location",
                  "Compare daily access, peak-hour commute and proximity to Golf Course Extension Road based on your own routine.",
                ],
                [
                  ShieldCheck,
                  "Unit-level diligence",
                  "Check title, dues, parking, fit-out condition, lender valuation and transfer requirements for the exact apartment.",
                ],
          ...
          <section id="current-inventory" className="scroll-mt-28">
            ...
            <h2 className="mt-2 font-display text-3xl">
              Published Tata Raisina Residency properties
            </h2>
            {listings.length ? (
                ...
                {listings.map((listing) => (
                  <article key={listing.id} className="rounded-xl border border-border bg-card p-5">
                    ...
                    <div className="mt-4 grid gap-2 text-sm text-muted-foreground sm:grid-cols-2">
                      <p>
                        <strong className="text-foreground">Config:</strong>{" "}
                        {listing.bhk || "Unit-specific"}
                      </p>
                      <p>
                        <strong className="text-foreground">Area:</strong>{" "}
                        {listing.area_sqft ? formatArea(listing.area_sqft) : "Confirm"}
                      </p>
                      <p>
                        <strong className="text-foreground">Floor:</strong>{" "}
                        {listing.floor || "Confirm"}
                      </p>
                      <p>
                        <strong className="text-foreground">Facing:</strong>{" "}
                        {listing.facing || "Confirm"}
                      </p>
                    </div>
                    <div className="mt-5 flex items-center justify-between gap-4 border-t border-border pt-4">
                      <p className="font-display text-lg">
                        {listing.price
                          ...
                          : listing.display_price || "Price on request"}
                      </p>
                      <Button asChild size="sm" variant="goldOutline">
                        <a href={listing.href}>View property</a>
                      </Button>
                    </div>
                  </article>
                ))}
              ...
              <div className="mt-6 rounded-xl border border-border bg-card p-6">
                <p className="font-medium">
                  No Tata Raisina Residency unit is being represented as live inventory on this page
                  right now.
                </p>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  We are keeping the project guide live without inventing availability. Ask us to
                  reconfirm owner inventory before planning a visit.
                </p>
              </div>
            )}
          </section>
          ...
          <section>
            ...
            <h2 className="mt-2 font-display text-3xl">
              Compare the exact residence, not only the project name
            </h2>
          ...
          <section className="rounded-2xl surface-navy p-7">
            ...
            <div className="mt-4 flex flex-wrap gap-x-5 gap-y-3 text-sm">
              <Link to="/property-sector-59-gurgaon" className="text-gold hover:underline">
                Sector 59 Gurgaon guide
              </Link>
              <Link
                to="/locations/$slug"
                params={{ slug: "golf-course-extension-road" }}
                className="text-gold hover:underline"
              >
                Golf Course Extension Road
              </Link>
              <Link to="/projects-in-gurgaon" className="text-gold hover:underline">
                All Gurgaon project guides
              </Link>
              <Link to="/flats-for-sale-in-gurgaon" className="text-gold hover:underline">
                Current Gurgaon properties
              </Link>
            </div>
          </section>
        </main>
        ...
        <aside className="rounded-xl border border-border bg-card p-6 lg:sticky lg:top-28 lg:self-start">
          <p className="text-xs uppercase tracking-[0.14em] text-muted-foreground">
            Tata Raisina Residency enquiry
          </p>
          ...
          <div className="mt-5">
            <EnquiryForm interest="Tata Raisina Residency Sector 59" compact />
          </div>
        </aside>
      </section>
    </>
