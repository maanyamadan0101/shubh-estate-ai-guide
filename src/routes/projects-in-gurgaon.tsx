...
export const Route = createFileRoute("/projects-in-gurgaon")({
  ...
  head: ({ loaderData }) => {
    const canonical = `${SITE_ORIGIN}/projects-in-gurgaon`;
    const title = "Residential Projects in Gurgaon | Shubh Estate Brokers";
    const description = `Explore ${GURGAON_PROJECT_COUNT} residential projects in Gurgaon by sector, corridor, developer, budget and possession stage, with transparent price, RERA and verification context.`;
    ...
    return {
      meta: [
        ...
        { property: "og:image", content: `${SITE_ORIGIN}/shubh-estate-logo.png` },
        {
          ...
          content: "Shubh Estate Brokers residential projects in Gurgaon directory",
        },
      ...
      <section className="border-b border-border bg-muted/35">
        <div className="container-page py-14 md:py-20">
          <nav aria-label="Breadcrumb" className="text-xs text-muted-foreground">
            ...
            <span className="text-foreground">Projects in Gurgaon</span>
          </nav>
          <div className="mt-6 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div className="max-w-4xl">
              ...
              <h1 className="mt-3 font-display text-4xl leading-tight md:text-5xl">
                Residential Projects in Gurgaon – New, Under-Construction & Ready-to-Move
              </h1>
              <p className="mt-5 max-w-3xl text-base leading-7 text-muted-foreground">
                Compare residential projects in Gurgaon by sector, corridor, developer, budget and
                possession stage. Price, RERA, area and inventory claims stay qualified until the
                exact unit and phase are reconfirmed.
              </p>
