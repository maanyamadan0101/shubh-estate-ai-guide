...
const VERIFIED_PROJECTS: readonly VerifiedProjectIntelligence[] = [
  ...
  {
    name: "Emaar Imperial Gardens",
    aliases: ["emaar imperial gardens", "imperial gardens", "imperial gardens sector 102"],
    developer: "Emaar India",
    sector: "Sector 102",
    corridor: "Dwarka Expressway",
    configurations: "3 BHK apartments",
    projectDescription:
      "Emaar Imperial Gardens is an established residential project in Sector 102, Gurugram by Emaar India. The developer's project page identifies a resident clubhouse, swimming facilities, tennis and badminton courts, children's recreation, jogging track, perimeter security and apartment power backup. That combination makes the society relevant to families comparing gated residential communities with recreation facilities on the Dwarka Expressway side of Gurgaon.",
    amenities: [
      "Clubhouse",
      "Swimming Pool",
      "Kids' Pool",
      ...
      "Culture Centre",
      "Perimeter Security",
      "5 KVA Power Backup per Apartment",
    ],
    highlights: [
      "Emaar residential community in Sector 102",
      "Clubhouse and swimming facilities",
      "Tennis and badminton courts",
      "Kids' play area and jogging track",
      "Perimeter security and apartment power backup",
    ],
    roadConnectivity: ["Dwarka Expressway corridor", "Gurugram city road network"],
    officialSourceUrls: ["https://in.emaar.com/en/properties/imperial-gardens/"],
    lastVerifiedDate: "2026-09-02",
  },
  {
    ...
    sector: "Sector 103",
    corridor: "Dwarka Expressway",
    landArea: "Approx. 5.14 acres (Phase 1)",
    towerFloorSummary: "2 residential towers of 43 storeys in Phase 1",
    configurations: "3 & 4 BHK residences",
    projectDescription:
      "Riviera at AIPL LakeCity is AIPL's residential development in Sector 103, Gurugram, approached from the Dwarka Expressway corridor. The official project information describes Phase 1 across approximately 5.14 acres with two 43-storey towers, substantial open space and a landscape plan centred around water and greenery. Resident facilities include a signature pool, central lake, mindfulness and landscaped gardens, outdoor gym, pet garden and sports area.",
    amenities: [
      ...
      "Pet Garden",
      "Miyawaki Forest",
      "Welcome & Sculptural Gardens",
      "Landscaped Open Spaces",
      "Clubhouse",
    ],
    highlights: [
      "Approx. 5.14-acre Phase 1",
      "Two 43-storey residential towers",
      "3 & 4 BHK residences",
      "Central lake and landscape-led planning",
      "IGBC Platinum pre-certified community",
      "Sector 103 location on the Dwarka Expressway corridor",
    ],
    roadConnectivity: ["Dwarka Expressway", "Sector 103 Gurugram road network"],
    officialSourceUrls: ["https://aipl.com/riviera/", "https://aipl.com/residential/"],
    lastVerifiedDate: "2026-09-02",
  },
  {
    name: "Puri Emerald Bay",
    aliases: ["puri emerald bay", "emerald bay sector 104", "puri emerald"],
    developer: "Puri Constructions",
    sector: "Sector 104",
    corridor: "Dwarka Expressway",
    status: "Delivered / ready to move",
    reraNumber: "136 of 2017, dated 28.08.2017",
    configurations: "2 & 3 BHK apartments",
    projectDescription:
      "Puri Emerald Bay is a delivered residential development by Puri Constructions in Sector 104, Gurugram. The developer positions it as a 2 and 3 BHK community on the Dwarka Expressway corridor with landscaped and water-led planning. The project's dedicated ANAROCK microsite documents two operational clubhouses serving tower clusters together with fitness, indoor recreation and outdoor sports facilities, supporting its relevance for end users seeking a ready gated society with an established amenity environment.",
    amenities: [
      "Two Operational Clubhouses",
      "Two Gymnasiums",
    ...
    highlights: [
      "Delivered residential community in Sector 104",
      "2 & 3 BHK apartment mix",
      "Two operational clubhouses",
      "Fitness, indoor recreation and outdoor sports facilities",
      "Dwarka Expressway residential corridor",
    ],
    roadConnectivity: ["Dwarka Expressway"],
    officialSourceUrls: [
      "https://puriconstructions.com/project-details/emerald-bay",
      "https://puri-emerald.sites.anarockdigital.com/",
    ],
    lastVerifiedDate: "2026-09-02",
  },
  {
    name: "Elan The Presidential",
    aliases: ["elan the presidential", "elan presidential", "the presidential sector 106"],
    developer: "Elan Group",
    sector: "Sector 106",
    corridor: "Dwarka Expressway",
    configurations: "Luxury residences; configuration varies by current inventory",
    projectDescription:
      "Elan The Presidential is Elan Group's residential development in Sector 106, Gurugram on Dwarka Expressway. Official Elan project material highlights a podium-level clubhouse, state-of-the-art swimming pool, landscaped green spaces and dedicated recreation areas for children, adults and senior residents. The location is positioned for access to Dwarka Expressway, Delhi and the wider Gurugram employment network, while unit-specific configuration, floor, view and asking price remain separate listing facts.",
    amenities: [
      "Clubhouse",
      "Swimming Pool",
      "Landscaped Green Spaces",
      ...
      "Adult Recreation & Wellness Areas",
    ],
    highlights: [
      "Sector 106 Dwarka Expressway address",
